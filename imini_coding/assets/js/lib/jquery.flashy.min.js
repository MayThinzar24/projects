! function(l, e, n, r) {
	...
	c.prototype = {
		...
		_addItem: function(t, e, o) {
			...
			n || (n = i++, t.data(a, n), t.on("click", l.proxy(this._onItemClick, this))), s.id = n, this.items.set(n, s)
		},
		_removeItem: function(t) {
			var e = t.data(a);
			e && (t.removeData(a), t.off("click", l.proxy(this._onItemClick, this)), this.items.del(e))
		},
